...
<div id="container" class="text-center pt-3">
    <div class="d-inline-block">
        <img class="background"src="{{asset('dau-check123.jpg')}}" width="100px" alt="">
    </div>
    <div class="" id="header">
    ...
    <div class="content">
        ...
        <ul class="content-product">
            ...
            <li class="clearfix" id="product">
                <img src="{{asset($item->options->thumb)}}" class="m-3 " alt="" width="130px">
...
<script type="text/javascript">
    function Redirect(){
        window.location = "http://localhost/unimart/users/checkout/destroy"

    }
    // document.write("<div class='alert alert-success'>  <p>Bạn sẽ chuyển hướng trong 10s !!!</p></div>");
