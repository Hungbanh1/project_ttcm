 ...
 <head>
     <title>HUNGBANHMART STORE</title>
     <meta charset="UTF-8">
     <meta name="viewport" content="width=device-width, initial-scale=1.0">
     <base href="http://localhost/unimart/users/">
     ...
     <script src="https://code.jquery.com/jquery-3.5.1.slim.min.js"
         ...
         <script src="{{ url('public/js/jquery-3.6.0.min.js') }}" type="text/javascript"></script>
  <script
     ...
     <link href="{{url('public/reset1.css')}}" rel="stylesheet" type="text/css" />
     ...
     <link href="{{url('public/css/add_css/style.css')}}" rel="stylesheet" type="text/css" />
     <link href="{{url('public/css/search/search.css')}}" rel="stylesheet" type="text/css" />
     <link href="public/bootstrap-reboot.css.map" rel="stylesheet" type="text/css" >


     <script src="{{url('public/js/viewmoree.js')}}"  type="text/javascript"></script>
     ...
     <script src="{{url('public/js/alertify.min.js')}}" type="text/javascript"></script>
     <script src="{{url('public/js/alertify.js')}}" type="text/javascript"></script>
                         ...
                         <div id="action-wp" class="fl-right">
                             ...
                             <div id="cart-wp" class="cart_show_again fl-right">
                                 ...
                                 <div id="dropdown" class="list_cart_show">
                                     ...
                                     @else
                                         <img src="{{url('public/images/cart_none.png')}}" alt="">
