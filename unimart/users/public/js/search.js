    ...
    $('.keyword').keyup(function () {
        ...
        timeout = setTimeout(function () {
            ...
            $.ajax({
                ...
                url: 'http://localhost/unimart/users/search/searchajax',
                ...
                success: function (data) {
                    ...
                    $.each(data.product, function (index, value) {
                        ...
                        var content =
                            '<li class="clearfix">' +
                            '<a href="http://localhost/unimart/users/san-pham/' +
                            value.cat_title +
                            '/' +
                            value.slug +
                            '">' +
                            '<div class="thumb-info fl-left">' +
                            '  <img src="http://localhost/unimart/users/public/images/' +
                            value.product_thumb +
                            '" alt="">' +
                            '</div>' +
                    ...
                    $('#search-data').css({
                        display: 'block',
                        transition: 'all 0.5s cubic-bezier(0.25, 0.1, 0.86, 0.25) 0s',
                    });
                },
